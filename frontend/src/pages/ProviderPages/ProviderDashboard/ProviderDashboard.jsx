  ...
  return (
    <>
        ...
        <div className='main-title'>
             ...
             <p>Share your skills,services and resources with your community.Make a</p>
              <p>meaningful impact  by helping others.</p>
        </div>
        ...
        <div className='provide'>
                 ...
                 <p>Browse through different categories to find opportunities to contribute to your community.</p>
        </div>
